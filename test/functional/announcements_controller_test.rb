...
class AnnouncementsControllerTest < ActionController::TestCase
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post :create, announcement: { ends_at: @announcement.ends_at, message: @announcement.message, starts_at: @announcement.starts_at }
    end
  ...
  test "should update announcement" do
    put :update, id: @announcement, announcement: { ends_at: @announcement.ends_at, message: @announcement.message, starts_at: @announcement.starts_at }
    assert_redirected_to announcement_path(assigns(:announcement))
  end
